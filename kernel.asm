...
80106dba:	75 16                	jne    80106dd2 <shm_open+0xe2>
    release(&(shm_table.lock));
...
80106dd2:	e8 d9 b6 ff ff       	call   801024b0 <kalloc>
80106dd7:	8d 1c 5b             	lea    (%ebx,%ebx,2),%ebx
80106dda:	c1 e3 02             	shl    $0x2,%ebx
80106ddd:	8d 93 c8 54 11 80    	lea    -0x7feeab38(%ebx),%edx
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106de3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dea:	00 
80106deb:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106df2:	00 
    shm_table.shm_pages[i].frame = kalloc();
80106df3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106df6:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[i].frame = kalloc();
80106df9:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106dff:	e8 8c d4 ff ff       	call   80104290 <memset>
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e04:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    shm_table.shm_pages[i].id = id; 
80106e07:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
    shm_table.shm_pages[i].refcnt = 1;
80106e0d:	c7 83 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%ebx)
80106e14:	00 00 00 
    uint va = PGROUNDUP(curproc->sz);
80106e17:	8b 07                	mov    (%edi),%eax
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e19:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e20:	00 
    uint va = PGROUNDUP(curproc->sz);
80106e21:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e27:	8b 42 30             	mov    0x30(%edx),%eax
    uint va = PGROUNDUP(curproc->sz);
80106e2a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e30:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e37:	00 
80106e38:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106e3c:	05 00 00 00 80       	add    $0x80000000,%eax
80106e41:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e45:	8b 47 04             	mov    0x4(%edi),%eax
80106e48:	89 04 24             	mov    %eax,(%esp)
80106e4b:	e8 00 f7 ff ff       	call   80106550 <mappages>
80106e50:	e9 33 ff ff ff       	jmp    80106d88 <shm_open+0x98>
80106e55:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106e89:	74 27                	je     80106eb2 <shm_close+0x52>
      if(shm_table.shm_pages[i].id == id)
...
80106e95:	83 a9 fc 54 11 80 01 	subl   $0x1,-0x7feeab04(%ecx)
80106e9c:	75 14                	jne    80106eb2 <shm_close+0x52>
            shm_table.shm_pages[i].frame = 0;
80106e9e:	c7 81 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%ecx)
80106ea5:	00 00 00 
            shm_table.shm_pages[i].id = 0;
80106ea8:	c7 81 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%ecx)
80106eaf:	00 00 00 
        }
   }
   release(&(shm_table.lock));
80106eb2:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106eb9:	e8 82 d3 ff ff       	call   80104240 <release>
   return 0; 

   //added to remove compiler warning -- you should decide what to return
}
80106ebe:	83 c4 14             	add    $0x14,%esp
