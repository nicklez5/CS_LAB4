...
80106d05:	e8 46 d4 ff ff       	call   80104150 <acquire>
  struct proc *curproc = myproc();
80106d0a:	e8 a1 c9 ff ff       	call   801036b0 <myproc>
...
80106d18:	eb 1e                	jmp    80106d38 <shm_open+0x48>
...
80106d22:	75 05                	jne    80106d29 <shm_open+0x39>
80106d24:	85 db                	test   %ebx,%ebx
80106d26:	0f 44 da             	cmove  %edx,%ebx
  for(i = 0; i < 64; i++){
80106d29:	83 c2 01             	add    $0x1,%edx
80106d2c:	83 c1 0c             	add    $0xc,%ecx
80106d2f:	83 fa 40             	cmp    $0x40,%edx
80106d32:	0f 84 80 00 00 00    	je     80106db8 <shm_open+0xc8>
    if(shm_table.shm_pages[i].id == id){
80106d38:	8b 01                	mov    (%ecx),%eax
80106d3a:	39 f0                	cmp    %esi,%eax
80106d3c:	75 e2                	jne    80106d20 <shm_open+0x30>
...
80106d3e:	8b 07                	mov    (%edi),%eax
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106d40:	8d 34 52             	lea    (%edx,%edx,2),%esi
80106d43:	c1 e6 02             	shl    $0x2,%esi
80106d46:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d4d:	00 
80106d4e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d55:	00 
    uint va = PGROUNDUP(curproc->sz);
80106d56:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106d5c:	8b 86 f8 54 11 80    	mov    -0x7feeab08(%esi),%eax
    uint va = PGROUNDUP(curproc->sz);
80106d62:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106d68:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106d6c:	05 00 00 00 80       	add    $0x80000000,%eax
80106d71:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d75:	8b 47 04             	mov    0x4(%edi),%eax
80106d78:	89 04 24             	mov    %eax,(%esp)
80106d7b:	e8 d0 f7 ff ff       	call   80106550 <mappages>
    shm_table.shm_pages[i].refcnt++;
80106d80:	83 86 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%esi)
80106d87:	90                   	nop
    *pointer = (char *)va;
80106d88:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d8b:	89 18                	mov    %ebx,(%eax)
    curproc->sz = PGROUNDUP(curproc->sz) + PGSIZE;     
80106d8d:	8b 07                	mov    (%edi),%eax
80106d8f:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d94:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106d99:	05 00 10 00 00       	add    $0x1000,%eax
80106d9e:	89 07                	mov    %eax,(%edi)
...
80106db8:	85 db                	test   %ebx,%ebx
80106dba:	74 e4                	je     80106da0 <shm_open+0xb0>
    shm_table.shm_pages[i].frame = kalloc();
80106dbc:	e8 ef b6 ff ff       	call   801024b0 <kalloc>
80106dc1:	8d 1c 5b             	lea    (%ebx,%ebx,2),%ebx
80106dc4:	c1 e3 02             	shl    $0x2,%ebx
80106dc7:	8d 93 c8 54 11 80    	lea    -0x7feeab38(%ebx),%edx
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106dcd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dd4:	00 
80106dd5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ddc:	00 
    shm_table.shm_pages[i].frame = kalloc();
80106ddd:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106de0:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[i].frame = kalloc();
80106de3:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
    memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106de9:	e8 a2 d4 ff ff       	call   80104290 <memset>
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106dee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    shm_table.shm_pages[i].id = id; 
80106df1:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
    shm_table.shm_pages[i].refcnt = 1;
80106df7:	c7 83 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%ebx)
80106dfe:	00 00 00 
    uint va = PGROUNDUP(curproc->sz);
80106e01:	8b 07                	mov    (%edi),%eax
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e03:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0a:	00 
    uint va = PGROUNDUP(curproc->sz);
80106e0b:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e11:	8b 42 30             	mov    0x30(%edx),%eax
    uint va = PGROUNDUP(curproc->sz);
80106e14:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    mappages(curproc->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e1a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e21:	00 
80106e22:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106e26:	05 00 00 00 80       	add    $0x80000000,%eax
80106e2b:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e2f:	8b 47 04             	mov    0x4(%edi),%eax
80106e32:	89 04 24             	mov    %eax,(%esp)
80106e35:	e8 16 f7 ff ff       	call   80106550 <mappages>
80106e3a:	e9 49 ff ff ff       	jmp    80106d88 <shm_open+0x98>
80106e3f:	90                   	nop
...
80106e47:	8b 5d 08             	mov    0x8(%ebp),%ebx
   int i;
   acquire(&(shm_table.lock));
80106e4a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e51:	e8 fa d2 ff ff       	call   80104150 <acquire>
80106e56:	ba f4 54 11 80       	mov    $0x801154f4,%edx
   for(i = 0; i < 64; i++){
80106e5b:	31 c0                	xor    %eax,%eax
80106e5d:	eb 0c                	jmp    80106e6b <shm_close+0x2b>
80106e5f:	90                   	nop
80106e60:	83 c0 01             	add    $0x1,%eax
80106e63:	83 c2 0c             	add    $0xc,%edx
80106e66:	83 f8 40             	cmp    $0x40,%eax
80106e69:	74 27                	je     80106e92 <shm_close+0x52>
      if(shm_table.shm_pages[i].id == id)
80106e6b:	39 1a                	cmp    %ebx,(%edx)
80106e6d:	75 f1                	jne    80106e60 <shm_close+0x20>
        break;
   }
   if(i < 64){
        shm_table.shm_pages[i].refcnt--;
80106e6f:	8d 0c 40             	lea    (%eax,%eax,2),%ecx
80106e72:	c1 e1 02             	shl    $0x2,%ecx
        if(shm_table.shm_pages[i].refcnt == 0){
80106e75:	83 a9 fc 54 11 80 01 	subl   $0x1,-0x7feeab04(%ecx)
80106e7c:	75 14                	jne    80106e92 <shm_close+0x52>
            shm_table.shm_pages[i].frame = 0;
80106e7e:	c7 81 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%ecx)
80106e85:	00 00 00 
            shm_table.shm_pages[i].id = 0;
80106e88:	c7 81 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%ecx)
80106e8f:	00 00 00 
        }
   }

   release(&(shm_table.lock));
80106e92:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e99:	e8 a2 d3 ff ff       	call   80104240 <release>
   return 0; 

   //added to remove compiler warning -- you should decide what to return
}
80106e9e:	83 c4 14             	add    $0x14,%esp
