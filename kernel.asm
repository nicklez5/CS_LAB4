...
80100b93:	e8 f8 1f 00 00       	call   80102b90 <end_op>
    cprintf("exec: fail\n");
80100b98:	c7 04 24 c1 6f 10 80 	movl   $0x80106fc1,(%esp)
...
80100d56:	c7 44 24 04 cd 6f 10 	movl   $0x80106fcd,0x4(%esp)
80100d5d:	80 
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 d4 6f 10 80 	movl   $0x80106fd4,(%esp)
...
80100ed7:	e9 b4 1c 00 00       	jmp    80102b90 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 dc 6f 10 80 	movl   $0x80106fdc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 e6 6f 10 80 	movl   $0x80106fe6,(%esp)
...
801010dc:	e9 1f 22 00 00       	jmp    80103300 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 ef 6f 10 80 	movl   $0x80106fef,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 f5 6f 10 80 	movl   $0x80106ff5,(%esp)
...
801011a5:	c7 04 24 ff 6f 10 80 	movl   $0x80106fff,(%esp)
...
801012cd:	c7 04 24 15 70 10 80 	movl   $0x80107015,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  panic("bmap: out of range");
80101387:	c7 04 24 25 70 10 80 	movl   $0x80107025,(%esp)
...
80101469:	c7 04 24 38 70 10 80 	movl   $0x80107038,(%esp)
...
8010148c:	c7 44 24 04 4b 70 10 	movl   $0x8010704b,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 52 70 10 	movl   $0x80107052,0x4(%esp)
801014b0:	80 
...
801014d6:	c7 04 24 b8 70 10 80 	movl   $0x801070b8,(%esp)
...
801015f1:	c7 04 24 58 70 10 80 	movl   $0x80107058,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 70 70 10 80 	movl   $0x80107070,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101786:	c7 04 24 6a 70 10 80 	movl   $0x8010706a,(%esp)
...
801017ce:	e9 1d 28 00 00       	jmp    80103ff0 <releasesleep>
    panic("iunlock");
801017d3:	c7 04 24 7f 70 10 80 	movl   $0x8010707f,(%esp)
...
80101c71:	c3                   	ret    
      panic("dirlookup read");
80101c72:	c7 04 24 99 70 10 80 	movl   $0x80107099,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 87 70 10 80 	movl   $0x80107087,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
      panic("dirlink read");
80101ef5:	c7 04 24 a8 70 10 80 	movl   $0x801070a8,(%esp)
...
80101fef:	c7 04 24 14 71 10 80 	movl   $0x80107114,(%esp)
80101ff6:	e8 65 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101ffb:	c7 04 24 0b 71 10 80 	movl   $0x8010710b,(%esp)
...
80102016:	c7 44 24 04 26 71 10 	movl   $0x80107126,0x4(%esp)
8010201d:	80 
...
801021e9:	eb bb                	jmp    801021a6 <iderw+0x76>
    panic("iderw: buf not locked");
801021eb:	c7 04 24 2a 71 10 80 	movl   $0x8010712a,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 55 71 10 80 	movl   $0x80107155,(%esp)
801021fe:	e8 5d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102203:	c7 04 24 40 71 10 80 	movl   $0x80107140,(%esp)
...
80102258:	c7 04 24 74 71 10 80 	movl   $0x80107174,(%esp)
...
8010238c:	eb bb                	jmp    80102349 <kfree+0x49>
    panic("kfree");
8010238e:	c7 04 24 a6 71 10 80 	movl   $0x801071a6,(%esp)
...
801023fb:	c7 44 24 04 ac 71 10 	movl   $0x801071ac,0x4(%esp)
80102402:	80 
...
80102544:	0f b6 81 e0 72 10 80 	movzbl -0x7fef8d20(%ecx),%eax
...
80102578:	0f b6 91 e0 72 10 80 	movzbl -0x7fef8d20(%ecx),%edx
  shift ^= togglecode[data];
8010257f:	0f b6 81 e0 71 10 80 	movzbl -0x7fef8e20(%ecx),%eax
  shift |= shiftcode[data];
...
8010258f:	8b 04 85 c0 71 10 80 	mov    -0x7fef8e40(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a8b:	c7 44 24 04 e0 73 10 	movl   $0x801073e0,0x4(%esp)
80102a92:	80 
...
80102cb2:	c3                   	ret    
    panic("log.committing");
80102cb3:	c7 04 24 e4 73 10 80 	movl   $0x801073e4,(%esp)
...
80102d6d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d70:	c7 04 24 f3 73 10 80 	movl   $0x801073f3,(%esp)
80102d77:	e8 e4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d7c:	c7 04 24 09 74 10 80 	movl   $0x80107409,(%esp)
...
80102da7:	c7 04 24 24 74 10 80 	movl   $0x80107424,(%esp)
...
80102f4f:	00 
80102f50:	c7 44 24 04 38 74 10 	movl   $0x80107438,0x4(%esp)
80102f57:	80 
...
8010300a:	00 
8010300b:	c7 44 24 04 3d 74 10 	movl   $0x8010743d,0x4(%esp)
80103012:	80 
...
8010309c:	ff 24 8d 7c 74 10 80 	jmp    *-0x7fef8b84(,%ecx,4)
801030a3:	90                   	nop
...
80103127:	0f 85 c5 fe ff ff    	jne    80102ff2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010312d:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
...
80103148:	eb e3                	jmp    8010312d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010314a:	c7 04 24 5c 74 10 80 	movl   $0x8010745c,(%esp)
...
801031ef:	c7 44 24 04 90 74 10 	movl   $0x80107490,0x4(%esp)
801031f6:	80 
...
801035f6:	c7 44 24 04 95 74 10 	movl   $0x80107495,0x4(%esp)
801035fd:	80 
...
8010366a:	c7 04 24 9c 74 10 80 	movl   $0x8010749c,(%esp)
80103671:	e8 ea cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 78 75 10 80 	movl   $0x80107578,(%esp)
...
80103792:	00 
80103793:	c7 44 24 04 c5 74 10 	movl   $0x801074c5,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 cd 0c 00 00       	call   80104470 <safestrcpy>
  p->cwd = namei("/");
801037a3:	c7 04 24 ce 74 10 80 	movl   $0x801074ce,(%esp)
...
801037d7:	c7 04 24 ac 74 10 80 	movl   $0x801074ac,(%esp)
...
80103a7e:	c7 04 24 d0 74 10 80 	movl   $0x801074d0,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a8a:	c7 04 24 fc 74 10 80 	movl   $0x801074fc,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a96:	c7 04 24 ee 74 10 80 	movl   $0x801074ee,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103aa2:	c7 04 24 e2 74 10 80 	movl   $0x801074e2,(%esp)
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bab:	c7 04 24 1d 75 10 80 	movl   $0x8010751d,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bb7:	c7 04 24 10 75 10 80 	movl   $0x80107510,(%esp)
...
80103c9e:	c7 04 24 2f 75 10 80 	movl   $0x8010752f,(%esp)
80103ca5:	e8 b6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103caa:	c7 04 24 29 75 10 80 	movl   $0x80107529,(%esp)
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 bf 78 10 80 	movl   $0x801078bf,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ebd:	ba 40 75 10 80       	mov    $0x80107540,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ec2:	77 11                	ja     80103ed5 <procdump+0x55>
80103ec4:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
      state = "???";
80103ecb:	b8 40 75 10 80       	mov    $0x80107540,%eax
...
80103ee0:	c7 04 24 44 75 10 80 	movl   $0x80107544,(%esp)
...
80103f29:	c7 04 24 81 6f 10 80 	movl   $0x80106f81,(%esp)
...
80103f5a:	c7 44 24 04 b8 75 10 	movl   $0x801075b8,0x4(%esp)
80103f61:	80 
...
801041b7:	eb ac                	jmp    80104165 <acquire+0x15>
    panic("acquire");
801041b9:	c7 04 24 c3 75 10 80 	movl   $0x801075c3,(%esp)
...
80104219:	c3                   	ret    
    panic("popcli");
8010421a:	c7 04 24 e2 75 10 80 	movl   $0x801075e2,(%esp)
80104221:	e8 3a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104226:	c7 04 24 cb 75 10 80 	movl   $0x801075cb,(%esp)
...
8010424f:	75 0f                	jne    80104260 <release+0x20>
    panic("release");
80104251:	c7 04 24 e9 75 10 80 	movl   $0x801075e9,(%esp)
...
8010466d:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
...
80104696:	c7 04 24 f1 75 10 80 	movl   $0x801075f1,(%esp)
...
80104820:	c7 44 24 04 9c 76 10 	movl   $0x8010769c,0x4(%esp)
80104827:	80 
...
8010483b:	c7 44 24 04 9b 76 10 	movl   $0x8010769b,0x4(%esp)
80104842:	80 
...
80104851:	79 89                	jns    801047dc <create+0xdc>
      panic("create dots");
80104853:	c7 04 24 8f 76 10 80 	movl   $0x8010768f,(%esp)
8010485a:	e8 01 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010485f:	c7 04 24 9e 76 10 80 	movl   $0x8010769e,(%esp)
80104866:	e8 f5 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010486b:	c7 04 24 80 76 10 80 	movl   $0x80107680,(%esp)
...
80104c11:	c7 44 24 04 9c 76 10 	movl   $0x8010769c,0x4(%esp)
80104c18:	80 
...
80104c29:	c7 44 24 04 9b 76 10 	movl   $0x8010769b,0x4(%esp)
80104c30:	80 
...
80104d7d:	c7 04 24 c0 76 10 80 	movl   $0x801076c0,(%esp)
80104d84:	e8 d7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d89:	c7 04 24 d2 76 10 80 	movl   $0x801076d2,(%esp)
80104d90:	e8 cb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d95:	c7 04 24 ae 76 10 80 	movl   $0x801076ae,(%esp)
...
80105283:	e8 28 1c 00 00       	call   80106eb0 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
801054c9:	c7 44 24 04 e1 76 10 	movl   $0x801076e1,0x4(%esp)
801054d0:	80 
...
80105560:	ff 24 85 88 77 10 80 	jmp    *-0x7fef8878(,%eax,4)
80105567:	90                   	nop
    lapiceoi();
    break;
...
801055d3:	c7 04 24 44 77 10 80 	movl   $0x80107744,(%esp)
...
801056cc:	c7 04 24 ec 76 10 80 	movl   $0x801076ec,(%esp)
...
8010578a:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
80105791:	89 44 24 04          	mov    %eax,0x4(%esp)
80105795:	e8 b6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010579a:	c7 04 24 e6 76 10 80 	movl   $0x801076e6,(%esp)
...
80105897:	00 
  for(p="xv6...\n"; *p; p++)
80105898:	bb 08 78 10 80       	mov    $0x80107808,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010647a:	c3                   	ret    
        panic("kfree");
8010647b:	c7 04 24 a6 71 10 80 	movl   $0x801071a6,(%esp)
...
801065c1:	c3                   	ret    
      panic("remap");
801065c2:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
...
801066d1:	c7 04 24 16 78 10 80 	movl   $0x80107816,(%esp)
801066d8:	e8 83 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066dd:	c7 04 24 41 78 10 80 	movl   $0x80107841,(%esp)
801066e4:	e8 77 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066e9:	c7 04 24 2c 78 10 80 	movl   $0x8010782c,(%esp)
...
8010677e:	c7 04 24 55 78 10 80 	movl   $0x80107855,(%esp)
...
80106832:	c7 04 24 6f 78 10 80 	movl   $0x8010786f,(%esp)
80106839:	e8 22 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010683e:	c7 04 24 10 79 10 80 	movl   $0x80107910,(%esp)
...
801068e2:	c7 04 24 8d 78 10 80 	movl   $0x8010788d,(%esp)
...
80106910:	c7 04 24 a5 78 10 80 	movl   $0x801078a5,(%esp)
...
801069d3:	e9 28 b9 ff ff       	jmp    80102300 <kfree>
    panic("freevm: no pgdir");
801069d8:	c7 04 24 c1 78 10 80 	movl   $0x801078c1,(%esp)
...
80106abb:	c3                   	ret    
    panic("clearpteu");
80106abc:	c7 04 24 d2 78 10 80 	movl   $0x801078d2,(%esp)
...
80106ba5:	eb e9                	jmp    80106b90 <copyuvm+0xc0>
      panic("copyuvm: page not present");
80106ba7:	c7 04 24 f6 78 10 80 	movl   $0x801078f6,(%esp)
80106bae:	e8 ad 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106bb3:	c7 04 24 dc 78 10 80 	movl   $0x801078dc,(%esp)
...
80106c96:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106c9d:	80 
...
80106cf4:	56                   	push   %esi
  int i;
  acquire(&(shm_table.lock));
80106cf5:	be f4 54 11 80       	mov    $0x801154f4,%esi
int shm_open(int id, char **pointer) { 
80106cfa:	53                   	push   %ebx
80106cfb:	83 ec 2c             	sub    $0x2c,%esp
80106cfe:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&(shm_table.lock));
80106d01:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d08:	e8 43 d4 ff ff       	call   80104150 <acquire>
80106d0d:	eb 10                	jmp    80106d1f <shm_open+0x2f>
80106d0f:	90                   	nop
80106d10:	83 c6 0c             	add    $0xc,%esi
  for(i = 0; i < 64; i++){
80106d13:	81 fe f4 57 11 80    	cmp    $0x801157f4,%esi
80106d19:	0f 84 99 00 00 00    	je     80106db8 <shm_open+0xc8>

    //Case 1 
    if(shm_table.shm_pages[i].id == id){
80106d1f:	39 3e                	cmp    %edi,(%esi)
80106d21:	75 ed                	jne    80106d10 <shm_open+0x20>
...
80106d2e:	e8 7d c9 ff ff       	call   801036b0 <myproc>
80106d33:	8b 08                	mov    (%eax),%ecx
80106d35:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
80106d3b:	e8 70 c9 ff ff       	call   801036b0 <myproc>
80106d40:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d43:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106d49:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106d4d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d54:	00 
80106d55:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d5c:	00 
80106d5d:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106d61:	8b 40 04             	mov    0x4(%eax),%eax
80106d64:	89 04 24             	mov    %eax,(%esp)
80106d67:	e8 e4 f7 ff ff       	call   80106550 <mappages>
       shm_table.shm_pages[i].refcnt++;
80106d6c:	83 46 08 01          	addl   $0x1,0x8(%esi)
80106d70:	83 c6 0c             	add    $0xc,%esi
       *pointer = (char *)PGROUNDUP(myproc()->sz); 
80106d73:	e8 38 c9 ff ff       	call   801036b0 <myproc>
80106d78:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d7b:	8b 00                	mov    (%eax),%eax
80106d7d:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d82:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106d87:	89 02                	mov    %eax,(%edx)
       myproc()->sz = PGROUNDUP(myproc()->sz) + PGSIZE;
80106d89:	e8 22 c9 ff ff       	call   801036b0 <myproc>
80106d8e:	89 c3                	mov    %eax,%ebx
80106d90:	e8 1b c9 ff ff       	call   801036b0 <myproc>
80106d95:	8b 08                	mov    (%eax),%ecx
80106d97:	81 c1 ff 0f 00 00    	add    $0xfff,%ecx
80106d9d:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80106da3:	81 c1 00 10 00 00    	add    $0x1000,%ecx
  for(i = 0; i < 64; i++){
80106da9:	81 fe f4 57 11 80    	cmp    $0x801157f4,%esi
       myproc()->sz = PGROUNDUP(myproc()->sz) + PGSIZE;
80106daf:	89 0b                	mov    %ecx,(%ebx)
  for(i = 0; i < 64; i++){
80106db1:	0f 85 68 ff ff ff    	jne    80106d1f <shm_open+0x2f>
80106db7:	90                   	nop
80106db8:	bb f4 54 11 80       	mov    $0x801154f4,%ebx
80106dbd:	eb 10                	jmp    80106dcf <shm_open+0xdf>
80106dbf:	90                   	nop
80106dc0:	83 c3 0c             	add    $0xc,%ebx
       //myproc()->sz += PGSIZE;
       //break;
    }
  }
  ...
  for(i = 0; i < 64; i++){
80106dc3:	81 fb f4 57 11 80    	cmp    $0x801157f4,%ebx
80106dc9:	0f 84 bf 00 00 00    	je     80106e8e <shm_open+0x19e>

     //Case 2 
     if(shm_table.shm_pages[i].id == 0){
80106dcf:	8b 03                	mov    (%ebx),%eax
80106dd1:	85 c0                	test   %eax,%eax
80106dd3:	75 eb                	jne    80106dc0 <shm_open+0xd0>

        shm_table.shm_pages[i].id = id; 
80106dd5:	89 3b                	mov    %edi,(%ebx)
80106dd7:	83 c3 0c             	add    $0xc,%ebx
        //ALLOCATING A PAGE 
        shm_table.shm_pages[i].frame = kalloc();
80106dda:	e8 d1 b6 ff ff       	call   801024b0 <kalloc>
80106ddf:	89 43 f8             	mov    %eax,-0x8(%ebx)
...
80106df5:	e8 96 d4 ff ff       	call   80104290 <memset>
        ...
        mappages(myproc()->pgdir, (void *)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106dfa:	8b 43 f8             	mov    -0x8(%ebx),%eax
        shm_table.shm_pages[i].refcnt = 1;
80106dfd:	c7 43 fc 01 00 00 00 	movl   $0x1,-0x4(%ebx)
        mappages(myproc()->pgdir, (void *)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106e04:	05 00 00 00 80       	add    $0x80000000,%eax
80106e09:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e0c:	e8 9f c8 ff ff       	call   801036b0 <myproc>
80106e11:	8b 08                	mov    (%eax),%ecx
80106e13:	8d b1 ff 0f 00 00    	lea    0xfff(%ecx),%esi
80106e19:	e8 92 c8 ff ff       	call   801036b0 <myproc>
80106e1e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e21:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106e27:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e2b:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e32:	00 
80106e33:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e3a:	00 
80106e3b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106e3f:	8b 40 04             	mov    0x4(%eax),%eax
80106e42:	89 04 24             	mov    %eax,(%esp)
80106e45:	e8 06 f7 ff ff       	call   80106550 <mappages>
        *pointer = (char *)PGROUNDUP(myproc()->sz);
80106e4a:	e8 61 c8 ff ff       	call   801036b0 <myproc>
80106e4f:	8b 55 0c             	mov    0xc(%ebp),%edx
80106e52:	8b 00                	mov    (%eax),%eax
80106e54:	05 ff 0f 00 00       	add    $0xfff,%eax
80106e59:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e5e:	89 02                	mov    %eax,(%edx)
        myproc()->sz = PGROUNDUP(myproc()->sz) + PGSIZE;
80106e60:	e8 4b c8 ff ff       	call   801036b0 <myproc>
80106e65:	89 c6                	mov    %eax,%esi
80106e67:	e8 44 c8 ff ff       	call   801036b0 <myproc>
80106e6c:	8b 08                	mov    (%eax),%ecx
80106e6e:	81 c1 ff 0f 00 00    	add    $0xfff,%ecx
80106e74:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80106e7a:	81 c1 00 10 00 00    	add    $0x1000,%ecx
  for(i = 0; i < 64; i++){
80106e80:	81 fb f4 57 11 80    	cmp    $0x801157f4,%ebx
        myproc()->sz = PGROUNDUP(myproc()->sz) + PGSIZE;
80106e86:	89 0e                	mov    %ecx,(%esi)
  for(i = 0; i < 64; i++){
80106e88:	0f 85 41 ff ff ff    	jne    80106dcf <shm_open+0xdf>
    }
  }
...
80106e95:	e8 a6 d3 ff ff       	call   80104240 <release>
  return 0; 
}
80106e9a:	83 c4 2c             	add    $0x2c,%esp
80106e9d:	31 c0                	xor    %eax,%eax
80106e9f:	5b                   	pop    %ebx
80106ea0:	5e                   	pop    %esi
80106ea1:	5f                   	pop    %edi
80106ea2:	5d                   	pop    %ebp
...
80106eb4:	83 ec 14             	sub    $0x14,%esp
80106eb7:	8b 5d 08             	mov    0x8(%ebp),%ebx
   acquire(&(shm_table.lock));
80106eba:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ec1:	e8 8a d2 ff ff       	call   80104150 <acquire>
80106ec6:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106ecb:	eb 0d                	jmp    80106eda <shm_close+0x2a>
80106ecd:	8d 76 00             	lea    0x0(%esi),%esi
80106ed0:	83 c0 0c             	add    $0xc,%eax
   int i;
   for(i = 0; i < 64; i++){
80106ed3:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ed8:	74 1c                	je     80106ef6 <shm_close+0x46>
      if(shm_table.shm_pages[i].id == id){
80106eda:	3b 18                	cmp    (%eax),%ebx
80106edc:	75 f2                	jne    80106ed0 <shm_close+0x20>
        if(shm_table.shm_pages[i].refcnt > 1){
80106ede:	8b 50 08             	mov    0x8(%eax),%edx
80106ee1:	83 fa 01             	cmp    $0x1,%edx
80106ee4:	7e 2a                	jle    80106f10 <shm_close+0x60>
            shm_table.shm_pages[i].refcnt--;
80106ee6:	83 ea 01             	sub    $0x1,%edx
80106ee9:	83 c0 0c             	add    $0xc,%eax
80106eec:	89 50 fc             	mov    %edx,-0x4(%eax)
   for(i = 0; i < 64; i++){
80106eef:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ef4:	75 e4                	jne    80106eda <shm_close+0x2a>
            shm_table.shm_pages[i].refcnt = 0;
        }
   ...
   release(&(shm_table.lock));
80106ef6:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106efd:	e8 3e d3 ff ff       	call   80104240 <release>
   return 0; 

   //added to remove compiler warning -- you should decide what to return
}
80106f02:	83 c4 14             	add    $0x14,%esp
80106f05:	31 c0                	xor    %eax,%eax
80106f07:	5b                   	pop    %ebx
80106f08:	5d                   	pop    %ebp
80106f09:	c3                   	ret    
80106f0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            shm_table.shm_pages[i].id = 0;
80106f10:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
            shm_table.shm_pages[i].frame = 0;
80106f16:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            shm_table.shm_pages[i].refcnt = 0;
80106f1d:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
80106f24:	eb aa                	jmp    80106ed0 <shm_close+0x20>
